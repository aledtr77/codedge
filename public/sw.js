...
const PRECACHE_URLS = [
  // La home inglese sta alla radice: è quella che si apre senza aver scelto
  // niente. Quella italiana serve lo stesso, o offline chi ha scelto l'italiano
  // verrebbe mandato su una pagina non in cache.
  "/",
  "/it/",
  "/site.webmanifest",
  "/site.it.webmanifest",
