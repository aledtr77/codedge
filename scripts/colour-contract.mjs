...
// in silence.
//
// The palette extractor exists twice on purpose: once inside this site, once as
// its own repo at aledtr77/palette-extractor, English-only and with nothing
// around it. Keeping them separate is a decision, not an accident — but the
// decision came with a hole. The ten functions below are the same maths in both,
...
const DEFAULT_IMPL = '../src/scripts/pages/tools/palette-extractor/palette-core.js';
